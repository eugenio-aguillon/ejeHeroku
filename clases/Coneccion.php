<?php
  $dsn ='mysql:dbname=proy; host=localhost'; //host=127.0.01
  $usuario ='root';
  $clave = '';
    try {
      ...
      print '<p><span class="label label-warning glyphicon-remove">Codigo:</span></p>';
      print $e->getCode();
      print '<p><span class="label label-warning glyphicon-remove">Mensaje de Error: </span></p>';
      print $e->getMessage();
      print "</div>";
    }
    /* try {
    ...
    function consultaA($coneccion, $sql){
      ...
      try {
        ...
        if($fila == 0){
          $msgok = $msgerror."<br> No existe conincidencia para realizar la accion sobre los";
        }
